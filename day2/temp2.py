...
def out(intcd):
    for (i,x) in enumerate(intcd):
        if(i%4==0):
            if(x==1):
                intcd[intcd[i+3]]=intcd[intcd[i+1]]+ intcd[intcd[i+2]]
